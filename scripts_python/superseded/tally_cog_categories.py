...
ANNOT_FILE = "candidate_annotations.emapper.annotations"
...
print(f"Total protein lines in annotation file: {total_lines} (expect 670)")
...
print(f"\nTotal COG letter-assignments (may exceed protein count, since some proteins carry multiple categories): {sum(cog_counts.values())}")
